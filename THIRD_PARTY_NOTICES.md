...
- License: Apache License, Version 2.0 (unmodified; also shipped as `LICENSE-readability.md`)

The notice supplied by the project (`node_modules/@mozilla/readability/LICENSE.md`):
